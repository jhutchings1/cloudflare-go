...
func (r *ScreenshotService) New(ctx context.Context, accountID string, params ScreenshotNewParams, opts ...option.RequestOption) (res *ScreenshotNewResponse, err error) {
